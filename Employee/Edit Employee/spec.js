describe('Authentication capabilities', function() {
  ...
  it('should redirect to the login page if trying to load protected page while not authenticated', function() {
    ...
    browser.get('http://10.100.106.16:4200');
  ...
  it('Should edit infofrmation of a employee', function(){


    var employeeBtn = element(by.css(''));
  ...
  it('Should logout', function(){
   ...
   /* var std1 = element(by.css('body > app-root > app-admin > div > div.pcoded-container.navbar-wrapper > div > div > div > div > div > div > div > app-student-list > div > div > div.table-responsive > table > tbody > tr:nth-child(1) > td.pointer.normal-link'));
    ...
    var profile = element(by.css('body > app-root > app-admin > div > div.pcoded-container.navbar-wrapper > nav > div > div.navbar-container > ul.nav-right.no-block.ng-trigger.ng-trigger-mobileMenuTop > li.user-profile.header-notification > a > span'));
    profile.click();
