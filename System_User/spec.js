describe('Authentication capabilities', function() {
  ...
  it('should redirect to the login page if trying to load protected page while not authenticated', function() {
    ...
    browser.get('http://10.100.103.143:4200/authentication/login');
...
it('should accept a valid id address and password', function() {
  ...
  it('just logout', function(){
   ...
   /* var std1 = element(by.css('body > app-root > app-admin > div > div.pcoded-container.navbar-wrapper > div > div > div > div > div > div > div > app-student-list > div > div > div.table-responsive > table > tbody > tr:nth-child(1) > td.pointer.normal-link'));
    ...
    var user = element(by.css('body > app-root > app-admin > div > div.pcoded-container.navbar-wrapper > nav > div > div.navbar-container > ul.nav-right.no-block.ng-trigger.ng-trigger-mobileMenuTop > li.user-profile.header-notification > a > span'));


    var EC2 = protractor.ExpectedConditions;
    browser.driver.wait(function () {
    browser.wait(EC2.visibilityOf(user), 120000);
      return user;
    });
    ...
    browser.driver.wait(function () {
    browser.wait(EC3.visibilityOf(logoutBtn), 120000);
      return logoutBtn;
    });
    ...
    browser.driver.wait(function () {
    browser.wait(EC4.visibilityOf(logoutBtn), 120000);
      return logoutBtn;
    });
    ...
    browser.driver.wait(function () {
    browser.wait(EC5.visibilityOf(logoutBtn), 120000);
      return logoutBtn;
    });
    ...
    browser.driver.wait(function () {
    browser.wait(EC6.visibilityOf(logoutBtn), 120000);
      return logoutBtn;
    });
    ...
    browser.driver.wait(function () {
    browser.wait(EC7.visibilityOf(logoutBtn), 120000);
      return logoutBtn;
    });
